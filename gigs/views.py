...
from .forms import GigCreationForm, GigEditForm, PlanEditForm, ShowcaseForm, CommentForm, PlanForm
...
def edit_plan(request, planid):
    ...
    return render(request, "gigs/plan_edit.html", context={"form": form, "plan": plan})
